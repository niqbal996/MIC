...
class MaizeDataset(torchvision.datasets.coco.CocoDetection):
    def __init__(
        self, ann_file, root, remove_images_without_annotations, transforms=None, is_source=True
    ):
        super(MaizeDataset, self).__init__(root, ann_file)
    ...
    def __getitem__(self, idx):
        img, anno = super(MaizeDataset, self).__getitem__(idx)
